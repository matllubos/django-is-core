...
setup(
    ...
    dependency_links=[
        'https://github.com/matllubos/django-piston/tarball/1.2.4#egg=django-piston-1.2.4',
        'https://github.com/matllubos/django-chamber/tarball/0.1.3#egg=django-chamber-0.1.3',
