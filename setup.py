...
setup(
    ...
    dependency_links=[
        'https://github.com/matllubos/django-piston/tarball/1.1.11#egg=django-piston-1.1.11',
        ...
        'https://github.com/LukasRychtecky/germanium/tarball/0.2.2#egg=germanium-0.2.2',
