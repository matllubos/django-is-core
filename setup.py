...
setup(
    ...
    dependency_links=[
        'https://github.com/matllubos/django-piston/tarball/1.2.6#egg=django-piston-1.2.6',
        ...
        'https://github.com/LukasRychtecky/germanium/tarball/1.0.1#egg=germanium-1.0.1',
