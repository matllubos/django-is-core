...
setup(
    ...
    dependency_links=[
        'https://github.com/matllubos/django-piston/tarball/1.2.7#egg=django-piston-1.2.7',
        ...
        'https://github.com/LukasRychtecky/germanium/tarball/1.0.2#egg=germanium-1.0.2',
