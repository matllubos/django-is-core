...
setup(
    ...
    dependency_links=[
        'https://github.com/druids/django-pyston/tarball/2.4.0#egg=django-pyston-2.4.0',
        'https://github.com/druids/django-chamber/tarball/0.2.1#egg=django-chamber-0.2.1',
