...
setup(
    ...
    dependency_links=[
        'https://github.com/matllubos/django-piston/tarball/1.1.0#egg=django-piston-1.1.0',
        'https://github.com/matllubos/django-chamber/tarball/0.0.2#egg=django-chamber-0.0.2',
