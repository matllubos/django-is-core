...
setup(
    ...
    dependency_links=[
        ...
        'https://github.com/matllubos/django-block-snippets/tarball/0.0.8#egg=django-block-snippets-0.0.8',
        'https://github.com/LukasRychtecky/germanium/tarball/0.1.2#egg=germanium-0.1.2',
    ],
    zip_safe=False
)
