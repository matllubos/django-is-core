...
class AndPermission(BasePermission):
    ...
    def has_permission(self, name, request, view, obj=None):
        return all(permission.has_permission(name, request, view, obj=obj) for permission in self._permissions)
    ...
    def __repr__(self):
        return '({})'.format(' & '.join(str(permission) for permission in self._permissions))
...
class OrPermission(BasePermission):
    ...
    def has_permission(self, name, request, view, obj=None):
        return any(permission.has_permission(name, request, view, obj=obj) for permission in self._permissions)
