...
DEFAULTS = {
    ...
    'HEADER_IMAGE': None,
    'ENVIRONMENT': None,
    'BACKGROUND_EXPORT_TASK_TIME_LIMIT_MINUTES': 90,
    'BACKGROUND_EXPORT_TASK_SOFT_TIME_LIMIT_MINUTES': 60,
    ...
    'BACKGROUND_EXPORT_EXPORTED_FILE_STORAGE': 'django.core.files.storage.DefaultStorage',
}
