...
class DefaultModelCoreViewMixin(DefaultCoreViewMixin):
    ...
    def get_verbose_name(self):
        return self.core.get_verbose_name() if self.verbose_name is None else self.verbose_name

    def get_verbose_name_plural(self):
        return self.core.get_verbose_name_plural() if self.verbose_name_plural is None else self.verbose_name_plural
